...
@section('content_header')
    <h1>Informações sobre a visita</h1>
	
	<ol class="breadcrumb">
    	<li><a href="{{route('visita.list')}}">Visita</a></li>
    	<li><a href="">Informações de visita</a></li>    	
    </ol>    
@stop
	...
	<div class="box">
		<div class="box-body">
			...
			@include('includes.alerts')
				...
				<h3>Informações sobre a visita do Sr(a):</h3>
				<div class="row">
					...
					<div class="col-sm-8">
						...
						<p>{{$visita->visitante->descDoc()}}: {{$visita->visitante->documento}}</p>
