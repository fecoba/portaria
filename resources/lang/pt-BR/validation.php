...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'documento'=> [
            'required'=> 'O campo número do documento é obrigatório.'
        ],
        'confirma'=>[
            'same' => 'Confirmação de senha inválida.'
        ],
        'grupo_usuarios_id'=>[
            'required'=> 'O campo grupo de usuários é obrigatório.'
        ],
        'name'=>[
        ...
        'password'=>[
            ...
            'min' => 'A senha deve possuir no mínimo 6 caracteres.',
            'max' => 'A senha deve possuir no máximo 8 caracteres',
        ],
        'passwordatual'=>[
            'required'=> 'Senha atual não informada.',
            'min' => 'A senha atual deve possuir no mínimo 6 caracteres.',
            'max' => 'A senha atual deve possuir no máximo 8 caracteres',
        ],

        'setor_id'=>[
            'exists'=> 'O setor informado ainda não foi cadastrado.',
        ],

        'visitante_id'=>[
            'exists'=> 'O visitante informado ainda não foi cadastrado.',
        ],
